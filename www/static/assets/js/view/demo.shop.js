	...
	******************************* **/
	function _shop() {
       ...
       function getsuk(arr) {
        ...
        function _addrs(boll) {
            ...
            function ajaxaddr(addr_id) {
                $.ajax({
                    url:"/uuu/address/getaddr/id/"+addr_id,
                    success:function (res) {
                        //console.log(res);
                        if(res.errno==0){
            ...
            function real_freight(addr_id) {
                $.ajax({
                    url:"/uuu/address/getfare/id/"+addr_id,
                    success:function (res) {
                        //console.log(res);
                        //return false;
      ...
      function addr_add_html(data){
            ...
            ' <a  href="/uuu/address/editaddrmodal/id/'+val.id+'" class="btn btn-default btn-xs edit"  data-toggle="ajaxModal" ><i class="fa fa-edit white" ></i> 编辑 </a>'+
