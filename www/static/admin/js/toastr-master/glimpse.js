...
(function($, pubsub, settings, data, elements, util) {
    var wireListeners = function() {
        ...
        openPopup = function() { //WHEN USE CLICKS OPEN BUTTON 
            ...
            settings.local('popupKeep', true); //This second item is used to detect difference between uuu closing the page and a redirect
