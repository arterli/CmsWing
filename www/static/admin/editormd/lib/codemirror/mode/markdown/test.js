...
(function() {
  ...
  FT("formatting_linkEmail",
     "[link&formatting&formatting-link <][link uuu@example.com][link&formatting&formatting-link >]");
  ...
  MT("linkEmail",
     "[link <uuu@example.com>] foo");

  MT("linkEmailDouble",
     "[link <uuu@example.com>] foo [link <uuu@example.com>]");
