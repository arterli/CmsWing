...
module.exports = app => {
  ...
  app.router.get('模版详情', '/admin/cms/template/info', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.info');
  ...
  app.router.post('编辑模版', '/admin/cms/template/edit', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.edit');
  ...
  app.router.get('删除模版', '/admin/cms/template/del', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.del');
