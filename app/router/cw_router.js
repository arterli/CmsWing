...
module.exports = app => {
  ...
  app.router.get('模版列表', '/admin/cms/template/list', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.list');
  ...
  app.router.post('添加模版', '/admin/cms/template/listadd', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.listadd');
  ...
  app.router.post('编辑模版文件', '/admin/cms/template/listedit', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.listedit');
  ...
  app.router.get('删除模版文件', '/admin/cms/template/listdel', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.listdel');
  ...
  app.router.get('使用首页模版', '/admin/cms/template/listuse', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.listuse');
  ...
  app.router.get('使用模版', '/admin/cms/template/use', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.use');
  app.router.post('添加内容', '/admin/cms/doc/docAdd', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.doc.docAdd');
  app.router.get('导出模版', '/admin/cms/template/export', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.export');
  ...
  app.router.post('导入模版', '/admin/cms/template/import', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.import');
  ...
  app.router.get('获取模版', '/admin/cms/template/getTemplate', app.middleware.sys.authAdminToken(), app.middleware.sys.rbac(), 'cms.template.getTemplate');
