  ...
  __call(){
   ...
   /**
    ...
    masssendnewsAction(){
        let api = new API('wxec8fffd0880eefbe', 'a084f19ebb6cc5dddd2988106e739a07');
        let self = this;
        api.massSendNews('ys1SXTdWnZhTZQB77MODarSaJ36xfoTG15deo5aGM3eRvEiuT034AMaUocc66uq9',['oVe9Ew0zHFp0up1CeNcK2J5RL4xs','oVe9Ew1nEItmuu-H5NoeZpK0xLzo'],(err,result)=>{
    ...
    uploadnewsAction(){
        ...
        api.uploadNews({"articles":[{
                "thumb_media_id":"lEnCBjCXpwLp_Tdh0ImV9KlGZ9Wd3MlTcPVxST3jApIRh2YE1Y9RSNhxEdLKYI7G",
                "author":"HH",
                "title":"Happy Day",
